...
async def handle_incoming_call(request: Request):
    ...
    # replace the text below with the desired introduction
    response.say("Please wait while we connect your call to Mimi, powered by GAIforresearch.com")
    response.pause(length=1)
    response.say("Hi, I am Mimi. Let me know if you are ready.")
...
async def handle_media_stream(websocket: WebSocket):
    ...
    try:
                ...
                try:
                    async for message in websocket.iter_text():
                        ...
                        if data['event'] == 'media' and openai_ws.open:
                            ...
                            # Decode and write incoming audio to file
                            decoded_audio = base64.b64decode(audio_payload)
                            await incoming_file.write(decoded_audio)
                ...
                try:
                    async for openai_message in openai_ws:
                        ...
                        if response.get('type') == 'response.audio.delta' and 'delta' in response:
                            ...
                            # Decode and write outgoing audio to file
                            decoded_outgoing_audio = base64.b64decode(audio_payload)
                            await outgoing_file.write(decoded_outgoing_audio)

                            # Re-encode to base64 for sending to Twilio
                            encoded_audio = base64.b64encode(decoded_outgoing_audio).decode('utf-8')
        ...
        await outgoing_file.close()
        print(f"Recording saved: {incoming_audio_path}, {outgoing_audio_path}")
    ...
    initial_conversation_item = {
        ...
        "item": {
            ...
            "content": [
                {
                    "type": "input_text",
                    "text": "Greet the user with 'Hello there! I am Mimi and I am a researcher from BI Norwegian Business School. Today, We would like to understand how you feel about scholars using generative AI in their research"
                }
            ]
        }
    }
